...
const AddProduct = () => {
  ...
  const handleAddProduct = () => {
    if (name && description && price) {
      dispatch(addProduct({ id: Date.now(), name, description, price, available: true }));
      setName('');
      setDescription('');
      setPrice('');
    }
  ...
  return (
    <div>
      <input type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Имя продукта" />
